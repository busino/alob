...
class ImageFilter(django_filters.FilterSet):
    ...
    created_gte = django_filters.DateFilter(name='created', label='Created >=', lookup_expr='gte')
    created_lt = django_filters.DateFilter(name='created', label='Created <', lookup_expr='lt')
